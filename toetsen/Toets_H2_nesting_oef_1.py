...
"""
for type in pc["processor"]["compatibele_sockets"]:
    print(f"De processor ondersteunt socket-type: {type}")

""" 2)
Het huidige geheugentype klopt niet. Verander "DDRM" naar "DDR5" in de dictionary.
"""
geheugen = pc["geheugen"][type] = "DDR5"
...
"""
for media in pc["opslagmedia"]:
    print(f"-{media}: {pc['opslagmedia'][media]['capaciteit']}")
